...
public class UrlsAPI implements OrganizationsStorageUrls {
  ...
  @Override
  @Validate
  public void getOrganizationsStorageUrls(String query, String totalRecords, int offset, int limit, Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void postOrganizationsStorageUrls(org.folio.rest.jaxrs.model.Url entity,
  ...
  @Override
  @Validate
  public void getOrganizationsStorageUrlsById(String id, Map<String, String> okapiHeaders,
  ...
  @Override
  @Validate
  public void deleteOrganizationsStorageUrlsById(String id, Map<String, String> okapiHeaders,
                                              Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void putOrganizationsStorageUrlsById(String id, org.folio.rest.jaxrs.model.Url entity,
                                           Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
