...
public class PhoneNumbersAPI implements OrganizationsStoragePhoneNumbers {
  ...
  @Override
  @Validate
  public void getOrganizationsStoragePhoneNumbers(String query, String totalRecords, int offset, int limit, Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void postOrganizationsStoragePhoneNumbers(org.folio.rest.jaxrs.model.PhoneNumber entity,
  ...
  @Override
  @Validate
  public void getOrganizationsStoragePhoneNumbersById(String id, Map<String, String> okapiHeaders,
  ...
  @Override
  @Validate
  public void deleteOrganizationsStoragePhoneNumbersById(String id, Map<String, String> okapiHeaders,
                                              Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void putOrganizationsStoragePhoneNumbersById(String id, org.folio.rest.jaxrs.model.PhoneNumber entity,
                                           Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
