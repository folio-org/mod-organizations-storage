...
public class PhoneNumbersAPI implements OrganizationsStoragePhoneNumbers {
  ...
  @Override
  @Validate
  public void getOrganizationsStoragePhoneNumbers(String query, int offset, int limit, String lang,
  ...
  public void postOrganizationsStoragePhoneNumbers(String lang, org.folio.rest.jaxrs.model.PhoneNumber entity,
      Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
    PgUtil.post(PHONE_NUMBER_TABLE, entity, okapiHeaders, vertxContext, PostOrganizationsStoragePhoneNumbersResponse.class,
        asyncResultHandler);
  }
  ...
  public void getOrganizationsStoragePhoneNumbersById(String id, String lang, Map<String, String> okapiHeaders,
    ...
    PgUtil.getById(PHONE_NUMBER_TABLE, PhoneNumber.class, id, okapiHeaders, vertxContext,
        GetOrganizationsStoragePhoneNumbersByIdResponse.class, asyncResultHandler);
  }
  ...
  public void deleteOrganizationsStoragePhoneNumbersById(String id, String lang, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
    PgUtil.deleteById(PHONE_NUMBER_TABLE, id, okapiHeaders, vertxContext, DeleteOrganizationsStoragePhoneNumbersByIdResponse.class,
        asyncResultHandler);
  }
  ...
  public void putOrganizationsStoragePhoneNumbersById(String id, String lang, org.folio.rest.jaxrs.model.PhoneNumber entity,
      Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
    PgUtil.put(PHONE_NUMBER_TABLE, entity, id, okapiHeaders, vertxContext, PutOrganizationsStoragePhoneNumbersByIdResponse.class,
        asyncResultHandler);
  }
}
