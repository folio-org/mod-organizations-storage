...
public class ContactsAPI implements OrganizationsStorageContacts {
  ...
  @Override
  @Validate
  public void getOrganizationsStorageContacts(String query, String totalRecords, int offset, int limit, Map<String, String> okapiHeaders,
  ...
  @Override
  @Validate
  public void postOrganizationsStorageContacts(org.folio.rest.jaxrs.model.Contact entity,
  ...
  @Override
  @Validate
  public void getOrganizationsStorageContactsById(String id, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void deleteOrganizationsStorageContactsById(String id, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  @Validate
  public void putOrganizationsStorageContactsById(String id, org.folio.rest.jaxrs.model.Contact entity,
      Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
