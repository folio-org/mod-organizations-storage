...
public enum TestEntities {
  ...
  INTERFACE("/organizations-storage/interfaces", Interface.class, "interface.sample", "name", "Test Portal", 13),
  ORGANIZATION("/organizations-storage/organizations", Organization.class, "organization.sample",  "code", "ABC123", 16),
